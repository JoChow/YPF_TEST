view: asset_bl_value_measure_h {
  sql_table_name: YPF_TEST_RDS.ASSET_BL_VALUE_MEASURE_H ;;
  ...
  set: detail {
    fields: [
      ...
      risk_level_dim.name,
      asset_bl_value_measure.asset_bl_value_measure_id,
      asset_bl_value_measure.value_model_inst_name
    ]
  }
}
