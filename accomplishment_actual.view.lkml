view: accomplishment_actual {
  sql_table_name: YPF_TEST_RDS.ACCOMPLISHMENT_ACTUAL ;;

  dimension: accomplishment_actual_id {
    primary_key: yes
    type: string
    sql: ${TABLE}.ACCOMPLISHMENT_ACTUAL_ID ;;
  }

  dimension: accomplishment_actual_value {
    type: string
    sql: ${TABLE}.ACCOMPLISHMENT_ACTUAL_VALUE ;;
  }
